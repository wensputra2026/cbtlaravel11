...
return [
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'cbtlaravel'),
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => false, // Non-strict untuk kompatibilitas penuh skema database lama CI3
            'engine' => null,
        ...
        'legacy_cbt' => [
            ...
            'database' => env('DB_LEGACY_DATABASE', env('DB_DATABASE', 'cbtlaravel')),
