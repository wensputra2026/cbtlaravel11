                            ...
                            <td class="py-3 px-3 text-center">
                                <div class="inline-flex items-center justify-center gap-1.5">
                                    ...
                                    <button type="button" 
                                            ...
                                            class="p-1.5 text-amber-700 bg-amber-50 hover:bg-amber-100 border border-amber-300 rounded-lg transition shadow-2xs" 
                                            title="Edit Rombel">
                                    ...
                                    <form action="{{ route('admin.master.kelas.destroy', $kelas->id_kelas) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kelas {{ $kelas->nama_kelas }}?')">
                                        ...
                                        @method('DELETE')
                                        <button type="submit" 
                                                class="p-1.5 text-rose-700 bg-rose-50 hover:bg-rose-100 border border-rose-300 rounded-lg transition shadow-2xs" 
                                                title="Hapus Rombel">
